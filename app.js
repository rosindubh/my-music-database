...
const music = {
  ...
  "jackson brown": {
    albums: {
      "saturate before using": {
        year: 1972,
        members: ["Jackson Browne - acoustic guitar, piano, vocals",
  ...
  "jethro tull": {
    albums: {
      aqualung: {
        ...
        members: {
          vocals: "Ian Anderson",
          bass: "Jeffery Hammond",
          guitar: "Martin Barre",
          keyboard: "Jeffrey Hammond",
          flute: 'Ian Anderson',
          drums: "Clive Bunker",
        },
        tracks: {
  ...
  "kate bush": {
    albums: {
      "the kick inside": {
        year: 1978,
        members: ["Kate Bush - lead and backing vocals; piano",
        ...
        tracks: {
          ...
          6: "Wuthering Heights",
          7: "James and the Golden Gun",
          8: "Feel It",
          9: "Oh to Be in Love",
          10: "L'Amour Looks Somethin Like You",
